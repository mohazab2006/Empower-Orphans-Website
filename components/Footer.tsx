    ...
    <footer className="bg-gradient-to-br from-eo-dark to-eo-teal text-white py-16">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          >
            <div className="mb-4">
              <Image src="/logosmall.svg" alt="Empower Orphans" width={40} height={40} />
            </div>
            <p className="text-white/80 text-sm leading-relaxed">
              Student-led chapters fundraising and volunteering to support orphaned and vulnerable children.
            </p>
          ...
          >
            <h4 className="font-brand text-lg font-semibold mb-4">Quick Links</h4>
          ...
          >
            <h4 className="font-brand text-lg font-semibold mb-4">Our Chapters</h4>
            <div className="space-y-3">
              <div>
                <h5 className="text-sm font-semibold mb-1">Carleton University</h5>
                <a
              ...
              <div>
                <h5 className="text-sm font-semibold mb-1">University of Ottawa</h5>
                <a
              ...
              <div className="pt-2">
                <a
                  href="https://www.linkedin.com/company/empowerorphans/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-white/80 hover:text-white transition-colors flex items-center gap-2"
                >
